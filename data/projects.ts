...
export const projects: IProject[] = [
	{
		...
		description: 'I\'ve gone through multiple iterations of this project, learning more and more as I go. It started in Python with Google Sheets as the backend and has now evolved into a single-page Next app powered by automated email scraping and categorization.',
		image: {
